...
Gem::Specification.new do |s|
  ...
  s.date = %q{2010-06-28}
  s.description = %q{A secure non evaling end user template engine with aesthetic markup. Liquid currently supports Ruby versions 1.8.7, 1.9.1 and 1.9.2. This version of the gem is currently being tested with Ruby on Rails 3 beta 4.}
